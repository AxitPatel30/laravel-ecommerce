...
<body class="bg bg-dark">
    ...
    {{-- data  --}}
            ...
            <div class="card" style="width: 18rem;">
               <a href="{{"discription/$data->productid"}}"><img src="uploads/photos/{{ $data->photo}}" class="card-img-top" alt="..."></a>
                <div class="card-body">
                ...
                <div class="card-body">
                  <a href="/usercart/{{$data->productid}}/{{  Auth::user()->email }}" class="card-link">Cart</a>
                  <a href="/buy/{{$data->productid}}" class="card-link">Buy</a>
                </div>
              </div>
            @endforeach
</body>
